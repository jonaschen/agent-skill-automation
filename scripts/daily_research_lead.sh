...
PERF_FILE="$PERF_DIR/research-lead-${DATE}${SESSION_SUFFIX}.json"
...
(cd "$REPO_ROOT" && timeout 1800 "$CLAUDE" --dangerously-skip-permissions --max-budget-usd 10.00 -p "You are the agentic-ai-research-lead. Read .claude/agents/agentic-ai-research-lead.md for your full instructions.
