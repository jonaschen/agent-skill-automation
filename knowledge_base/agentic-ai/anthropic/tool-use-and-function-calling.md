...
### 2026-04-22 — Programmatic Tool Calling GA on Opus 4.7 via code_execution_20260120
- **What**: Programmatic calling is now GA on 5 models including Opus 4.7. Intermediate tool results do not count toward token usage, offering massive efficiency for multi-step research.
- **Significance**: Security analysis (2026-04-18) confirms this tool bypasses 4/5 harness hooks; it remains blocked by `permissions.deny` in this repo until an audit layer is designed.
- **Source**: [platform.claude.com](https://platform.claude.com/docs/en/about-claude/models/overview)
