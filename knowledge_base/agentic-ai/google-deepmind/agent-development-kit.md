...
- **Source**: https://medium.com/google-cloud/multi-agent-a2a-with-the-agent-development-kit-adk-cloud-run-and-gemini-cli-52f8be838ad6, https://github.com/google/adk-python/releases
...
- **Significance**: Day 1 post-v1.31.0. The "Agent-first workflows" I/O session title increases confidence that ADK v2.0 will be a headline I/O deliverable. The v1.31.0 "Computer Use View" is a new observation — it provides visual monitoring of computer-use tasks, complementing the workflow graph visualization from v2.0.0a3. No action items.
- **Source**: https://github.com/google/adk-python/releases, https://www.technobezz.com/news/google-io-2026-schedule-puts-ai-ahead-of-android-17-and-chrome-updates
