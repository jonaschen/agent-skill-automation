...
### 2026-04-21 (afternoon) — Agent Builder Day 62+; No Releases; ADK Unfreeze Does Not Extend Here
- **What**: Agent Builder last release Feb 18. No new release notes. ADK broke freeze today (v1.31.1, **corrected from v1.32.0**) but Agent Builder remains frozen. I/O 28d.
- **Significance**: One sentence: Agent Builder freeze deepens, all new features routing through ADK instead.
- **Source**: https://docs.cloud.google.com/agent-builder/release-notes
...
- **Significance**: The 59-day Agent Builder silence is now approaching two full months — unprecedented for a Google Cloud product line that had a roughly biweekly release cadence before the freeze. The **ADK v1.31.0 AgentEngineSandboxCodeExecutor** is notable as the first new Agent Engine surface area in weeks — it arrived via the ADK release pipeline rather than the Agent Builder release notes, suggesting Google is routing new Agent Engine capabilities through ADK releases during the freeze. This pattern may continue until I/O: Agent Engine features ship in ADK versions while the Agent Builder product page stays frozen for the relaunch. For our pipeline: keep Phase 5 designs Agent-Engine-API-agnostic until the I/O relaunch clarifies the post-rebrand surface. The ADK v1.31.0 Service Registry pattern is worth monitoring as a model for plugin-style agent deployment.
- **Source**: https://docs.cloud.google.com/agent-builder/release-notes, https://docs.cloud.google.com/vertex-ai/generative-ai/docs/release-notes, https://github.com/google/adk-python/releases
