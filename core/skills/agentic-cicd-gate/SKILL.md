---
name: Agentic CI/CD Gate
description: Manages the deployment pipeline for agents with automated quality gating, impact prediction, and rollback. See `core/agents/agentic-cicd-gate.md` for the full agent definition.
kind: local
