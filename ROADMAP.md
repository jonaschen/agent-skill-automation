...
- [ ] **Pilot Run 2**: Kick off `./scripts/run_stress_pilot.sh` tonight (2026-04-13 ~22:00). Uses `--pilot-mode`. Success criterion: ≥8/10 DEPLOYED. Post-pilot regression test runs automatically. This closes 4.2a gate.
